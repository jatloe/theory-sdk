...
var init = () => {
    ...
    // c1
    {
        ...
        c11 = theory.createUpgrade(baseId + 0, currency, new FirstFreeCost(new ExponentialCost(3, Math.log2(10))));
    ...
    // c3
    {
        ...
        c13 = theory.createUpgrade(baseId + 2, currency, new ExponentialCost(5, Math.log2(10)));
